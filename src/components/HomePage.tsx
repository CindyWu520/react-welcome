  ...
  return (
    <>
      ...
      <Card>
        ...
        <input
          className="border border-white focus:border-blue-500 focus:ring focus:ring-blue-200 outline-none rounded-2xl text-white"
          type="text"
          defaultValue={name}
        />
        <p className="bg-blue-700">length: {items.length}</p>
        <p>sum: {1 + 1}</p>
